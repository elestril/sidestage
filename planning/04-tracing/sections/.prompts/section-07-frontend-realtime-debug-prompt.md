...
Generate content for section `section-07-frontend-realtime-debug` (filename: `section-07-frontend-realtime-debug.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/harald/src/sidestage/planning/04-tracing/claude-plan.md` - Full implementation plan
2. `/home/harald/src/sidestage/planning/04-tracing/claude-plan-tdd.md` - Test stubs for each section
3. `/home/harald/src/sidestage/planning/04-tracing/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-07-frontend-realtime-debug` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/04-tracing/sections/section-07-frontend-realtime-debug.md`
