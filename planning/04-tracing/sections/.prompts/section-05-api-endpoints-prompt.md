...
Generate content for section `section-05-api-endpoints` (filename: `section-05-api-endpoints.md`).
...
for `section-05-api-endpoints` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/04-tracing/sections/section-05-api-endpoints.md`
