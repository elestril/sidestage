...
Generate content for section `section-06-frontend-trace-viewer` (filename: `section-06-frontend-trace-viewer.md`).
...
for `section-06-frontend-trace-viewer` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/04-tracing/sections/section-06-frontend-trace-viewer.md`
