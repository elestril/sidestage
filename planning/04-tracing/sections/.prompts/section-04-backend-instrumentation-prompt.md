...
Generate content for section `section-04-backend-instrumentation` (filename: `section-04-backend-instrumentation.md`).
...
for `section-04-backend-instrumentation` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/04-tracing/sections/section-04-backend-instrumentation.md`
