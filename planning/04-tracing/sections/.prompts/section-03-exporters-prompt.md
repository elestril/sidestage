...
Generate content for section `section-03-exporters` (filename: `section-03-exporters.md`).
...
for `section-03-exporters` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/04-tracing/sections/section-03-exporters.md`
