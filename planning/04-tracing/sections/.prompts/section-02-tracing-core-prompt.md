...
Generate content for section `section-02-tracing-core` (filename: `section-02-tracing-core.md`).
...
for `section-02-tracing-core` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/04-tracing/sections/section-02-tracing-core.md`
