...
Generate content for section `section-01-tracing-config` (filename: `section-01-tracing-config.md`).
...
for `section-01-tracing-config` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/04-tracing/sections/section-01-tracing-config.md`
