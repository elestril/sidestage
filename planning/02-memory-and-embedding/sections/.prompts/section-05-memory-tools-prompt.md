...
Generate content for section `section-05-memory-tools` (filename: `section-05-memory-tools.md`).
...
for `section-05-memory-tools` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/02-memory-and-embedding/sections/section-05-memory-tools.md`
