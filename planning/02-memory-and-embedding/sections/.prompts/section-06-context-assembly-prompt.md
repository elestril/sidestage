...
Generate content for section `section-06-context-assembly` (filename: `section-06-context-assembly.md`).
...
for `section-06-context-assembly` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/02-memory-and-embedding/sections/section-06-context-assembly.md`
