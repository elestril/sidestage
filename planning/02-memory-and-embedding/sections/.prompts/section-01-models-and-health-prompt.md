...
Generate content for section `section-01-models-and-health` (filename: `section-01-models-and-health.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/harald/src/sidestage/planning/02-memory-and-embedding/claude-plan.md` - Full implementation plan
2. `/home/harald/src/sidestage/planning/02-memory-and-embedding/claude-plan-tdd.md` - Test stubs for each section
3. `/home/harald/src/sidestage/planning/02-memory-and-embedding/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-01-models-and-health` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/02-memory-and-embedding/sections/section-01-models-and-health.md`
