...
Generate content for section `section-07-agent-integration` (filename: `section-07-agent-integration.md`).
...
for `section-07-agent-integration` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/02-memory-and-embedding/sections/section-07-agent-integration.md`
