...
Generate content for section `section-04-embeddings` (filename: `section-04-embeddings.md`).
...
for `section-04-embeddings` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/02-memory-and-embedding/sections/section-04-embeddings.md`
