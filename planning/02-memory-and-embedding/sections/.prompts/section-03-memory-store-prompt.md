...
Generate content for section `section-03-memory-store` (filename: `section-03-memory-store.md`).
...
for `section-03-memory-store` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/02-memory-and-embedding/sections/section-03-memory-store.md`
