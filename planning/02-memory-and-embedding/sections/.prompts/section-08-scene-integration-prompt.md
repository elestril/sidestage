...
Generate content for section `section-08-scene-integration` (filename: `section-08-scene-integration.md`).
...
for `section-08-scene-integration` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/02-memory-and-embedding/sections/section-08-scene-integration.md`
