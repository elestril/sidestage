...
Generate content for section `section-02-schema-migration` (filename: `section-02-schema-migration.md`).
...
for `section-02-schema-migration` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/02-memory-and-embedding/sections/section-02-schema-migration.md`
