...
Generate content for section `section-05-queries` (filename: `section-05-queries.md`).
...
for `section-05-queries` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/01-falkordb-foundation/sections/section-05-queries.md`
