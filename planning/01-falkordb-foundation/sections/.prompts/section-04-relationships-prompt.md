...
Generate content for section `section-04-relationships` (filename: `section-04-relationships.md`).
...
for `section-04-relationships` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/01-falkordb-foundation/sections/section-04-relationships.md`
