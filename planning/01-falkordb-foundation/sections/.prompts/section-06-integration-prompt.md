...
Generate content for section `section-06-integration` (filename: `section-06-integration.md`).
...
for `section-06-integration` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/01-falkordb-foundation/sections/section-06-integration.md`
