...
Generate content for section `section-03-entities` (filename: `section-03-entities.md`).
...
for `section-03-entities` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/01-falkordb-foundation/sections/section-03-entities.md`
