...
Generate content for section `section-02-frontend-mocks` (filename: `section-02-frontend-mocks.md`).
...
for `section-02-frontend-mocks` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/06-frontend-testing/sections/section-02-frontend-mocks.md`
