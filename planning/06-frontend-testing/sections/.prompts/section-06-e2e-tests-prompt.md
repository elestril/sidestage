...
Generate content for section `section-06-e2e-tests` (filename: `section-06-e2e-tests.md`).
...
for `section-06-e2e-tests` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/06-frontend-testing/sections/section-06-e2e-tests.md`
