...
Generate content for section `section-05-mock-actor` (filename: `section-05-mock-actor.md`).
...
for `section-05-mock-actor` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/06-frontend-testing/sections/section-05-mock-actor.md`
