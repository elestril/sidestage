...
Generate content for section `section-03-component-tests` (filename: `section-03-component-tests.md`).
...
for `section-03-component-tests` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/06-frontend-testing/sections/section-03-component-tests.md`
