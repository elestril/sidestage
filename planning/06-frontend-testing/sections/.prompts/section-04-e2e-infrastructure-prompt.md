...
Generate content for section `section-04-e2e-infrastructure` (filename: `section-04-e2e-infrastructure.md`).
...
for `section-04-e2e-infrastructure` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/06-frontend-testing/sections/section-04-e2e-infrastructure.md`
