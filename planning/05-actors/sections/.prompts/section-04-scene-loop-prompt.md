...
Generate content for section `section-04-scene-loop` (filename: `section-04-scene-loop.md`).
...
for `section-04-scene-loop` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/05-actors/sections/section-04-scene-loop.md`
