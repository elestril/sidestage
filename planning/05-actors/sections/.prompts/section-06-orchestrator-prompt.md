...
Generate content for section `section-06-orchestrator` (filename: `section-06-orchestrator.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/harald/src/sidestage/planning/05-actors/claude-plan.md` - Full implementation plan
2. `/home/harald/src/sidestage/planning/05-actors/claude-plan-tdd.md` - Test stubs for each section
3. `/home/harald/src/sidestage/planning/05-actors/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-06-orchestrator` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/05-actors/sections/section-06-orchestrator.md`
