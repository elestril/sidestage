...
Generate content for section `section-01-event-model` (filename: `section-01-event-model.md`).
...
for `section-01-event-model` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/05-actors/sections/section-01-event-model.md`
