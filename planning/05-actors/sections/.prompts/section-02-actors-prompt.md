...
Generate content for section `section-02-actors` (filename: `section-02-actors.md`).
...
for `section-02-actors` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/05-actors/sections/section-02-actors.md`
