...
Generate content for section `section-05-tracing` (filename: `section-05-tracing.md`).
...
for `section-05-tracing` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/05-actors/sections/section-05-tracing.md`
