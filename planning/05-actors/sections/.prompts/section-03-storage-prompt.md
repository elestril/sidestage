...
Generate content for section `section-03-storage` (filename: `section-03-storage.md`).
...
for `section-03-storage` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/05-actors/sections/section-03-storage.md`
