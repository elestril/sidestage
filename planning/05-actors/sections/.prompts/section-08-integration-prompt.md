...
Generate content for section `section-08-integration` (filename: `section-08-integration.md`).
...
for `section-08-integration` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/05-actors/sections/section-08-integration.md`
