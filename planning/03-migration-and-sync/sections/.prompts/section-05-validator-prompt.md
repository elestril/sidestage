...
Generate content for section `section-05-validator` (filename: `section-05-validator.md`).
...
for `section-05-validator` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/03-migration-and-sync/sections/section-05-validator.md`
