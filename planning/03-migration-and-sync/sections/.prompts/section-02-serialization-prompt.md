...
Generate content for section `section-02-serialization` (filename: `section-02-serialization.md`).
...
for `section-02-serialization` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/03-migration-and-sync/sections/section-02-serialization.md`
