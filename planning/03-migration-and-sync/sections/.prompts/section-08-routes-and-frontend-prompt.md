...
Generate content for section `section-08-routes-and-frontend` (filename: `section-08-routes-and-frontend.md`).

## Context Files

Read these files first to understand the full implementation plan:

1. `/home/harald/src/sidestage/planning/03-migration-and-sync/claude-plan.md` - Full implementation plan
2. `/home/harald/src/sidestage/planning/03-migration-and-sync/claude-plan-tdd.md` - Test stubs for each section
3. `/home/harald/src/sidestage/planning/03-migration-and-sync/sections/index.md` - Section manifest and descriptions

## Your Section

In `index.md`, locate the `<!-- SECTION_MANIFEST ... -->` block. Find the entry
for `section-08-routes-and-frontend` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/03-migration-and-sync/sections/section-08-routes-and-frontend.md`
