...
Generate content for section `section-06-exporter` (filename: `section-06-exporter.md`).
...
for `section-06-exporter` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/03-migration-and-sync/sections/section-06-exporter.md`
