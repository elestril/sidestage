...
Generate content for section `section-03-test-campaign` (filename: `section-03-test-campaign.md`).
...
for `section-03-test-campaign` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/03-migration-and-sync/sections/section-03-test-campaign.md`
