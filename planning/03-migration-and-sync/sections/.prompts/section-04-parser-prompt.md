...
Generate content for section `section-04-parser` (filename: `section-04-parser.md`).
...
for `section-04-parser` to understand what this section should contain.
...
`/home/harald/src/sidestage/planning/03-migration-and-sync/sections/section-04-parser.md`
