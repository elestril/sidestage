...
+      "commit_hash": "5d90462"
   ...
   "pre_commit": {
diff --git a/tests/unit/test_migration_integration.py b/tests/unit/test_migration_integration.py
new file mode 100644
index 0000000..ab325a6
--- /dev/null
+++ b/tests/unit/test_migration_integration.py
@@ -0,0 +1,684 @@
...
+                        mdumped = yaml.dump(dict(mfm), default_flow_style=False)
