...
### `assemble_context(client: GraphClient, owner_id: str, scene_id: str, present_character_ids: list[str], recent_messages: list[ChatMessageModel], context_limit: int, chat_history_ratio: float = 0.2, character_names: dict[str, str] | None = None) -> ContextResult` *async*
