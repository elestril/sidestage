# chat-flow: Basic chat interaction

The '/' page shows a chat window where the user can send messages and receive replies from every character present in the active scene.
